...
async def download_fiduciary_short_pdf(
    ...
    """Redirect directly to the official DOL EFAST2 public portal to download the actual raw Form 5500-SF document for this EIN."""
    from fastapi.responses import RedirectResponse
    clean_ein = "".join(c for c in str(ein) if c.isdigit())[-9:].zfill(9)
    return RedirectResponse(
        url=f"https://www.efast.dol.gov/5500search/",
        status_code=307
    )
